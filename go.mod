...
require (
	...
	github.com/cloudwego/eino-ext/components/indexer/milvus v0.0.0-20260331071634-4f359694d2d9 // indirect
	github.com/cloudwego/eino-ext/components/model/ark v0.1.65 // indirect
	github.com/cloudwego/eino-ext/components/retriever/milvus v0.0.0-20260408111519-100ca7063d18 // indirect
